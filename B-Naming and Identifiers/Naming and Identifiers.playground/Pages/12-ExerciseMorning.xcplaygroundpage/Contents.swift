 ...
 */
let thingsLikeToDo = goJogging + fixLunch
let thingsMustTodo = brushTeeth + uploadPhotos + chooseClothes + shower + finishHomework
let totalTimegroup = thingsLikeToDo + thingsMustTodo
/*:
